 ...
 */
 ...
 // Matter 1.4 Application Cluster Specification 8.11. Oven Mode Cluster
...
// Matter 1.4 Application Cluster Specification 8.11.5.1 ModeOptionStruct Type 
...
// Matter 1.4 Application Cluster Specification 8.11.6 Attributes
...
impl Handler for OvenModeCluster {
    fn read(
        &self,
        exchange: &Exchange,
        attr: &AttrDetails,
        ...
        OvenModeCluster::read(self, exchange, attr, encoder)
    }
}

impl NonBlockingHandler for OvenModeCluster {}

impl ChangeNotifier<()> for OvenModeCluster {
